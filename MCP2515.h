...
const byte BYTES_TO_READ = 0x04;
const byte BYTES_TO_SEND = 0x04;
...
const byte REGISTER_RXB1CTRL_VALUE = 0x22;  // Receive messages with standard identifier that meet filter criteria (filter 2)
 ...
 byte REGISTER_RXF0SIDL_VALUE;
 byte REGISTER_RXF1SIDL_VALUE;
 byte REGISTER_RXF2SIDL_VALUE;
 byte REGISTER_RXF3SIDL_VALUE;
 byte REGISTER_RXF4SIDL_VALUE;
 byte REGISTER_RXF5SIDL_VALUE;

 byte REGISTER_RXFxSIDL_VALUE[] = { REGISTER_RXF0SIDL_VALUE, REGISTER_RXF1SIDL_VALUE , REGISTER_RXF2SIDL_VALUE , REGISTER_RXF3SIDL_VALUE , REGISTER_RXF4SIDL_VALUE , REGISTER_RXF5SIDL_VALUE };

 byte REGISTER_RXF0SIDH_VALUE;
 byte REGISTER_RXF1SIDH_VALUE;
 byte REGISTER_RXF2SIDH_VALUE;
 byte REGISTER_RXF3SIDH_VALUE;
 byte REGISTER_RXF4SIDH_VALUE;
 byte REGISTER_RXF5SIDH_VALUE;

 byte REGISTER_RXFxSIDH_VALUE[] = { REGISTER_RXF0SIDH_VALUE, REGISTER_RXF1SIDH_VALUE , REGISTER_RXF2SIDH_VALUE , REGISTER_RXF3SIDH_VALUE , REGISTER_RXF4SIDH_VALUE , REGISTER_RXF5SIDH_VALUE };
